...
from .views import (
    ...
    RestorePasswordView, RestorePasswordDoneView, RestorePasswordConfirmView, FileFieldFormView,
    NoQuotaView
)
"""
from .views import (
    LogInView, SignUpView, LogOutView, ChangePasswordView, FileFieldFormView,
    NoQuotaView
)
